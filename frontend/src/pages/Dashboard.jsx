...
//     // Check if form is already filled for the current user
//     const currentUser = localStorage.getItem("userEmail");
    
//     // Get form status specifically for this user
//     const isFormFilled = localStorage.getItem(`formFilled_${currentUser}`) === "true";
...
//     const currentUser = localStorage.getItem("userEmail");
//     // Store form completion status tied to specific user
//     localStorage.setItem(`formFilled_${currentUser}`, "true");
//     setFormFilled(true);
//     setShowForm(false);
//   };

//   // Function to render the correct content based on user state
//   const renderRightSection = () => {
//     // If form is already filled, show the next steps options
//     if (formFilled) {
//       return (
...
//     // If form is not filled but show form is active
//     if (showForm) {
//       return <MedicalForm onSubmit={handleFormSubmit} />;
//     }
    
//     // Default state - form not filled and not showing form
//     return (
//       <div className="max-w-lg mx-auto py-8">
